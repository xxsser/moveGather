(function() {
    var h = {},
        mt = {},
        c = {
            id: "0afe5b3f700b54d21a953eebf7efcda8",
            dm: ["m.wo116114.com"],
    ...
    var q = !0,
        ...
        s = !1;
    mt.k = {};
    mt.k.ua = /msie (\d+\.\d+)/i.test(navigator.userAgent);
    ...
    mt.k.ya = (window.screen.width || 0) + "x" + (window.screen.height || 0);
    mt.k.colorDepth = window.screen.colorDepth || 0;
    mt.cookie = {};
    mt.cookie.set = function(a, b, e) {
        var d;
        e.G && (d = new Date, d.setTime(d.getTime() + e.G));
        document.cookie = a + "=" + b + (e.domain ? "; domain=" + e.domain: "") + (e.path ? "; path=" + e.path: "") + (d ? "; expires=" + d.toGMTString() : "") + (e.Va ? "; secure": "")
    };
    ...
    mt.s.Oa = function(a, b) {
        ...
        document.addEventListener ? f = function() {
            document.removeEventListener("DOMContentLoaded", f, s);
            a()
        }: document.attachEvent && (f = function() {
            "complete" === document.readyState && (document.detachEvent("onreadystatechange", f), a())
        }); (function() {
            if (!e) if (e = q, "complete" === document.readyState) a.A = q;
            else if (document.addEventListener) document.addEventListener("DOMContentLoaded", f, s),
    ...
    mt.event = {};
    mt.event.d = function(a, b, e) {
        a.attachEvent ? a.attachEvent("on" + b,
            function(b) {
                e.call(a, b)
            }) : a.addEventListener && a.addEventListener(b, e, s)
    };
                ...
                default:
                    ...
                    if (d instanceof Array) {
                        var f = ["["],
                            ...
                            g,
                            l;
                        for (g = 0; g < e; g++) switch (l = d[g], typeof l) {
                            case "undefined":
                            case "function":
                            case "unknown":
                                break;
                    ...
                    p = ["{"];
                    g = mt.l.stringify;
                    for (e in d) if (Object.prototype.hasOwnProperty.call(d, e)) switch (l = d[e], typeof l) {
                        case "undefined":
                        case "unknown":
                        case "function":
                            break;
    ...
    mt.N.La = function(a, b, e, d, f) {
        return '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="' + a + '" width="' + e + '" height="' + d + '"><param name="movie" value="' + b + '" /><param name="flashvars" value="' + (f || "") + '" /><param name="allowscriptaccess" value="always" /><embed type="application/x-shockwave-flash" name="' + a + '" width="' + e + '" height="' + d + '" src="' + b + '" flashvars="' + (f || "") + '" allowscriptaccess="always" /></object>'
    };
    mt.url = {};
    ...
    h.r = {
        ...
        Ha: 1,
        U: 2147483647,
        W: "cc cf ci ck cl cm cp cu cw ds ep et fl ja ln lo lt nv rnd si st su v cv lv api tt u".split(" ")
    }; (function() {
        var a = {
            o: {},
            d: function(a, e) {
            ...
            w: function(a, e) {
                this.o[a] = this.o[a] || [];
                for (var d = this.o[a].length, f = 0; f < d; f++) this.o[a][f](e)
            }
        };
        return h.F = a
    })(); (function() {
        function a(a, d) {
            ...
            f.charset = "utf-8";
            b.e(d, "Function") && (f.readyState ? f.onreadystatechange = function() {
                if ("loaded" === f.readyState || "complete" === f.readyState) f.onreadystatechange = r,
                    d()
            }: f.onload = function() {
                d()
            });
        ...
        function e(a) {
            var t = document,
                l = "";
            if (a in t) l = a;
            else for (var n = ["webkit", "ms", "moz", "o"], b = 0; b < n.length; b++) {
                var d = n[b] + a.charAt(0).toUpperCase() + a.slice(1);
                if (d in t) {
                    l = d;
                    break
                }
        ...
        function d(a) {
            if (! ("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window)) k = "focus" == a.type || "focusin" == a.type ? q: s,
                b()
        }
        var f = mt.event,
            m = h.F,
        ...
        b(); (function() {
            ...
            "object" == typeof document.onfocusin ? (f.d(document, "focusin", d), f.d(document, "focusout", d)) : (f.d(window, "focus", d), f.d(window, "blur", d))
        })();
        h.D = {
            ia: function() {
                return + new Date - v
            ...
            g = {
                ...
                ba: function() {
                    var a = window._hmt,
                        b = c.id,
                        d = {};
                    if (e.e(a, "Array")) for (var t = 0; t < a.length; t++) {
                        var n = a[t],
                            f = n[0];
                        e.e(n, "Array") && ("_setAccount" === f ? 1 < n.length && /^[0-9a-f]{32}$/.test(n[1]) && (g.c |= 1, b = n[1]) : (d[b] = d[b] || [], d[b].push(n)))
                    }
                    if (e.e(a, "Array") || !a) window._hmt = {
                        account: b,
                        commands: d,
                        push: function() {
                ...
                ca: function() {
                    var a = window._hmt;
                    if (a && a.commands && a.commands[c.id]) for (var b = a.commands[c.id], d = /^_track(Event|MobConv|Order|RTEvent)$/, t = 0, n = b.length; t < n; t++) {
                        var f = b[t];
                        d.test(f[0]) ? g.q.push(f) : g.K(f)
                    }
                    a.commands[c.id] = {
                        push: g.K
                    }
                ...
                da: function() {
                    if (0 < g.q.length) for (var a = 0,
                                                 b = g.q.length; a < b; a++) g.K(g.q[a]);
                    g.q = r
                },
                K: function(a) {
                    var b = a[0];
                    if (g.hasOwnProperty(b) && e.e(g[b], "Function")) g[b](a)
                },
                _setAccount: function(a) {
                    1 < a.length && /^[0-9a-f]{32}$/.test(a[1]) && (g.c |= 1, window._hmt.account = a[1])
                },
                _setAutoPageview: function(a) {
                    if (1 < a.length && (a = a[1], s === a || q === a)) g.c |= 2,
                        h.b.Q = a
                },
                _trackPageview: function(a) {
                    if (1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
                        ...
                        h.b.a.et = 0;
                        h.b.a.ep = "";
                        h.b.I ? (h.b.a.nv = 0, h.b.a.st = 4) : h.b.I = q;
                        var b = h.b.a.u,
                            d = h.b.a.su;
                        h.b.a.u = f.protocol + "//" + document.location.host + a[1];
                        g.S || (h.b.a.su = document.location.href);
                        h.b.i();
                        h.b.a.u = b;
                        h.b.a.su = d
                    }
                ...
                _trackEvent: function(a) {
                    2 < a.length && (g.c |= 8, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 4, h.b.a.ep = b(a[1]) + "*" + b(a[2]) + (a[3] ? "*" + b(a[3]) : "") + (a[4] ? "*" + b(a[4]) : ""), h.b.i())
                },
                _setCustomVar: function(a) {
                    if (! (4 > a.length)) {
                        ...
                        if (0 < d && 6 > d && 0 < f && 4 > f) {
                            g.B++;
                            for (var t = (h.b.a.cv || "*").split("!"), n = t.length; n < d - 1; n++) t.push("*");
                            t[d - 1] = f + "*" + b(a[2]) + "*" + b(a[3]);
                            h.b.a.cv = t.join("!");
                ...
                _setReferrerOverride: function(a) {
                    1 < a.length && (h.b.a.su = a[1].charAt && "/" === a[1].charAt(0) ? f.protocol + "//" + window.location.host + a[1] : a[1], g.S = q)
                },
                _trackOrder: function(b) {
                    b = b[1];
                    e.e(b, "Object") && (a(b), g.c |= 16, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 94, h.b.a.ep = d.stringify(b), h.b.i())
                },
                ...
                _trackRTPageview: function(b) {
                    b = b[1];
                    e.e(b, "Object") && (a(b), b = d.stringify(b), 512 >= encodeURIComponent(b).length && (g.c |= 64, h.b.a.rt = b))
                },
                _trackRTEvent: function(b) {
                    ...
                    if (e.e(b, "Object")) {
                        ...
                        else for (var m = Math.ceil(m / 900), t = "block|" + Math.round(Math.random() * f.U).toString(16) + "|" + m + "|", n = [], u = 0; u < m; u++) n.push(u),
                            n.push(b.substring(900 * u, 900 * u + 900)),
                            k.call(this, t + n.join("|")),
                            n = []
                    }
                },
        ...
        a.prototype = {
            ...
            z: function(a) {
                for (var n = 0; n < c.dm.length; n++) if ( - 1 < c.dm[n].indexOf("/")) {
                    if (this.T(a, c.dm[n])) return q
                } else {
                    var d = b.P(a);
                    if (d && this.J(d, c.dm[n])) return q
                }
                return s
            },
            H: function() {
            ...
            ka: function() {
                if (!document.referrer) return k.m - k.p > c.vdur ? 1 : 4;
                var a = s;
                this.z(document.referrer) && this.z(document.location.href) ? a = q: (a = b.P(document.referrer), a = this.J(a || "", document.location.hostname));
                return a ? k.m - k.p > c.vdur ? 1 : 4 : 3
            },
            getData: function(a) {
                try {
                    return m.get(a) || l.get(a) || g.get(a)
                } catch(b) {}
            },
            ...
            Da: function() {
                var a, b, d, f, e;
                k.p = this.getData("Hm_lpvt_" + c.id) || 0;
                13 === k.p.length && (k.p = Math.round(k.p / 1E3));
                b = this.ka();
                a = 4 !== b ? 1 : 0;
            ...
            Ba: function() {
                for (var a = [], b = 0, d = k.W.length; b < d; b++) {
                    var f = k.W[b],
                        e = this.a[f];
            ...
            Ea: function() {
                ...
                this.a.cm = b.j(a, k.pa) || "";
                this.a.cp = b.j(a, k.qa) || "";
                this.a.cw = b.j(a, k.oa) || "";
                this.a.ci = b.j(a, k.ma) || "";
                this.a.cf = b.j(a, k.ra) || "";
                this.a.cu = b.j(a, k.na) || ""
            },
            init: function() {
                try {
                    this.Ea(),
                        0 === this.a.nv ? this.Aa() : this.L(".*"),
                        h.b = this,
                        this.$(),
                        v.w("pv-b"),
                        this.za()
            ...
            za: function() {
                ...
                this.Q ? (this.I = q, this.a.et = 0, this.a.ep = "", this.i(a)) : a()
            },
            i: function(a) {
                var b = this;
                b.a.rnd = Math.round(Math.random() * k.U);
                v.w("stag-b");
                var d = k.protocol + "//" + k.V + "?" + b.Ba();
                v.w("stag-d");
                b.X(d);
                e.log(d,
                    function(d) {
            ...
            $: function() {
                var a = document.location.hash.substring(1),
                    d = RegExp(c.id),
                    f = -1 < document.referrer.indexOf(k.Y),
                    e = b.j(a, "jn"),
                    g = /^heatlink$|^select$/.test(e);
                a && (d.test(a) && f && g) && (a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", k.protocol + "//" + c.js + e + ".js?" + this.a.rnd), e = document.getElementsByTagName("script")[0], e.parentNode.insertBefore(a, e))
            },
            X: function(a) {
            ...
            Aa: function() {
                ...
                if (b) for (var b = b.split(","), d = function(b) {
                        e.log(k.protocol + "//" + decodeURIComponent(b),
                            function(b) {
                                a.L(b)
                            })
                    },
        ...
        try {
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                ...
                var g = function() {
                    ...
                    var n = r;
                    b = r;
                    if ("www.baidu.com" === (a.match(/^(http[s]?:\/\/)?([^\/]+)(.*)/) || [])[2]) n = e.j(a, "qid"),
                        b = e.j(a, "click_t");
                    a = n;
                    g.qid = a != r ? a: "";
                    b != r ? (g.bdDom = p ? p - b: 0, g.bdRun = f - b, g.bdDef = m("navigation").start - b) : (g.bdDom = 0, g.bdRun = 0, g.bdDef = 0);
                    h.b.a.et = 87;
        ...
        if (c.comm && "undefined" !== typeof h.b) {
            var d = function(a) {
                ...
                m = {
                    click: function() {
                        for (var a = [], b = d(document.getElementsByTagName("a")), b = [].concat.apply(b, d(document.getElementsByTagName("area"))), b = [].concat.apply(b, d(document.getElementsByTagName("img"))), e = 0, g = b.length; e < g; e++) {
                            var m = b[e],
                                k = m.getAttribute("onclick"),
                                m = m.getAttribute("href"); (f.test(k) || f.test(m)) && a.push(b[e])
                        }
                        return a
                    }
                },
                ...
                g = function(b, d) {
                    ...
                    if (d) {
                        var m = d.getAttribute("href"),
                            ...
                            l = d.getAttribute("id") || "";
                        f.test(m) ? (g.sn = "mediate", g.snv = m) : a.e(k, "String") && f.test(k) && (g.sn = "wrap", g.snv = k);
                        g.id = l
                    }
                    h.b.a.et = 86;
                ...
                l,
                k = "/zoosnet" + (/\/$/.test("/zoosnet") ? "": "/"),
                v = function(b, d) {
                    if (l === d) return g(k + b, d),
                        s;
                    if (a.e(d, "Array") || a.e(d, "NodeList")) for (var f = 0,
                                                                        e = d.length; f < e; f++) if (l === d[f]) return g(k + b + "/" + (f + 1), d[f]),
                        s
                };
            b.d(document, "click",
                function(b) {
                    ...
                    for (p(m,
                        function(b, f) {
                            d[b] = a.e(f, "Function") ? f() : document.getElementById(f)
                        }); l && l !== document && p(d, v) !== s;) l = l.parentNode
                })
        }
    })(); (function() {
        var a = mt.event,
        ...
        a.prototype = {
            ...
            va: function() {
                var a = this;
                this.ea(function(d) {
                    void 0 !== d && "" !== d && (b.log("//datax.baidu.com/x.gif?dm=" + encodeURIComponent("datax.baidu.com/webadapter/guid") + "&ac=" + encodeURIComponent(d) + "&v=hm-webadapter-0.0.1&rnd=" + Math.round(2147483647 * Math.random())), a.Ca("hmKey", +new Date,
                        function() {
                            a.Ga()
                        }))
                })
        ...
        if (e.ua && /^http(s)?:$/.test(document.location.protocol)) {
            var d = new a;
            d.ta(function(a) {
                0 === a && d.ha("hmKey",
                    function(a) {
                        a = +a; (isNaN(a) || 6048E5 < +new Date - a) && d.va()
                    })
            })
        }
    })();
})();/**
 * Created by KaiNaLove on 2016/1/21.
 */
